...
void WonderNews_SetReward(u32 newsType)
{
    ...
    case WONDER_NEWS_RECV_WIRELESS:
        // Random berry between ITEM_SITRUS_BERRY and ITEM_NOMEL_BERRY
        data->berry = (Random() % 15) + ITEM_TO_BERRY(ITEM_SITRUS_BERRY);
        break;
    case WONDER_NEWS_SENT:
        // Random berry between ITEM_CHERI_BERRY and ITEM_SITRUS_BERRY
