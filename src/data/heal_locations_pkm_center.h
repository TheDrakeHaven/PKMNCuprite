...
static const struct HealLocation sHealLocationsPokemonCenter[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_AEROBASE - 1] =
    {
        .group = MAP_GROUP(AERO_BASE_LOBBY),
        .map = MAP_NUM(AERO_BASE_LOBBY),
        .x = 4,
        .y = 11,
    },
    [HEAL_LOCATION_ROUTE_135 - 1] =
    {
        .group = MAP_GROUP(NEW_MAP1),
        .map = MAP_NUM(NEW_MAP1),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
};
...
static const u8 sHealNpcLocalId[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_AEROBASE - 1] = 1,
    [HEAL_LOCATION_ROUTE_135 - 1] = 1,
};
