...
{
    {COMPOUND_STRING("ABILITY PATCH 100 COINS")},
    {COMPOUND_STRING("ABILITY CAP 100 COINS")},
    {gText_Exit},
};

static const struct MenuAction MultichoiceList_GameCornerTMs[] =
{
    {COMPOUND_STRING("TM27{CLEAR_TO 0x48}2,000 COINS")},
...
static const struct MenuAction MultichoiceList_EEVEE3[] =
{
    {gtext_Duskstone},
    {gtext_Dawnstone},
    {gtext_Shinystone},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_EEVEE_STONE3]                = MULTICHOICE(MultichoiceList_EEVEE3),
};
