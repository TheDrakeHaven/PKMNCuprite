...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_DROUGHT, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .baseSpeed     = 50,
        .baseSpAttack  = 70,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 80 : 80,
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON),
        .catchRate = 90,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 140,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_DAMP, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_RAZOR_CLAW, SPECIES_WEAVILE},
                                {EVO_ITEM, ITEM_ICE_STONE, SPECIES_WEAVILE}),
    },
    ...
    [SPECIES_URSARING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GUTS, ABILITY_MINDS_EYE, ABILITY_UNNERVE },
    #else
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_PURPLE,
