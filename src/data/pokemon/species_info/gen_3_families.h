...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_OVERGROW, ABILITY_UNBURDEN, ABILITY_ARMOR_TAIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_DAMP, ABILITY_SOLID_ROCK },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STAKEOUT, ABILITY_GLUTTONY, ABILITY_QUICK_FEET },
    #else
        .abilities = { ABILITY_PICKUP, ABILITY_NONE, ABILITY_QUICK_FEET },
    #endif
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_HARIYAMA] =
    {
        ...
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 200,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 390 : 390,
        .evYield_HP = 1,
        .evYield_Attack =1,
        .evYield_Defense =1,
        .evYield_SpAttack =1,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_KEEN_EYE, ABILITY_INSOMNIA, ABILITY_PRANKSTER },
    #else
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_WIND_POWER, ABILITY_SWARM, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_DRIZZLE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_SAND_STREAM, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_CLAYDOL}),
    },
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PRESSURE, ABILITY_STAKEOUT, ABILITY_FRISK },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .baseSpeed     = 65,
        .baseSpAttack  = 95,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 105 : 80,
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 159,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_ICE_BODY, ABILITY_SNOW_WARNING },
    #else
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_ICE_BODY, ABILITY_SKILL_LINK },
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
