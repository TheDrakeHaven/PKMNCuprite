static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LAVARIDGE_TOWN - 1] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), 14, 7},
    ...
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), 13, 16},
    ...
    [HEAL_LOCATION_AEROBASE - 1] = {MAP_GROUP(AERO_BASE_LOBBY), MAP_NUM(AERO_BASE_LOBBY), 4, 11},
    [HEAL_LOCATION_ROUTE_135 - 1] = {MAP_GROUP(ROUTE135), MAP_NUM(ROUTE135), 17, 38},
};
