...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_DIDNOTLEARNMOVE]                      = COMPOUND_STRING("{B_BUFF1} chose not to learn {B_BUFF2}.\p"),
    ...
    [STRINGID_PLAYERGOTMONEY]                       = COMPOUND_STRING("You extorted ¥{B_BUFF1} for winning!\p"),
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("You have no more Pokémon that can fight!\p"),
#if B_WHITEOUT_MONEY >= GEN_4
    [STRINGID_PLAYERWHITEOUT2]                      = COMPOUND_STRING("In shame you dropped ¥{B_BUFF1}…\pYou must get stronger!{PAUSE_UNTIL_PRESS}"),
#else
    ...
    [STRINGID_PKMNCRASHED]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} kept going and hit a wall!"),
    ...
    [STRINGID_DONTLEAVEBIRCH]                       = COMPOUND_STRING("PROF. LEE: Don't leave me like this!\p"), //no decapitalize until it is everywhere
    ...
    [STRINGID_SAMUELUSEDITEM]                       = COMPOUND_STRING("SAMUEL used {B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    ...
    [STRINGID_PKMNGOTOVERITSINFATUATION]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} doesn't love them anymore!"),
...
const u8 gText_BattleWallyName[] = _("SAMUEL");
