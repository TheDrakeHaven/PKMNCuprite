...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_GAMER, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {TRAINER_CLASS_LEADER, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {TRAINER_CLASS_SCHOOL_KID, TRAINER_ENCOUNTER_MUSIC_MALE},
};

static const u16 sPrizeListRareCandy1[]  = {ITEM_RARE_CANDY,       ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListLuxuryBall1[] = {ITEM_ULTRA_BALL,      ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxRevive1[]  = {ITEM_MAX_REVIVE,       ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxEther1[]   = {ITEM_MAX_ETHER,        ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListElixir1[]     = {ITEM_MAX_ELIXIR,           ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListRoar[]        = {ITEM_TM_ALLURING_VOICE,  ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListSludgeBomb[]  = {ITEM_TM_SLUDGE_BOMB,   ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListToxic[]       = {ITEM_TM_TOXIC,         ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM_SUNNY_DAY,     ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListEarthQuake[]  = {ITEM_TM_EARTHQUAKE,    ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};

static const u16 sPrizeListRareCandy2[]  = {ITEM_RARE_CANDY,       ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListLuxuryBall2[] = {ITEM_ULTRA_BALL,      ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxRevive2[]  = {ITEM_MAX_REVIVE,       ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxEther2[]   = {ITEM_MAX_ETHER,        ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListElixir2[]     = {ITEM_MAX_ELIXIR,           ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListBrickBreak[]  = {ITEM_TM_BRICK_BREAK,   ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListTorment[]     = {ITEM_TM_TORMENT,       ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListSkillSwap[]   = {ITEM_TM_SKILL_SWAP,    ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListGigaDrain[]   = {ITEM_TM_GIGA_DRAIN,    ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
static const u16 sPrizeListAttract[]     = {ITEM_TM_ATTRACT,       ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_GREAT_BALL};
