...
} sIncenseBabyTable[] =
{
    ...
    { SPECIES_WOBBUFFET,    ITEM_ABILITY_PATCH,  SPECIES_WYNAUT },
    { SPECIES_MARILL,       ITEM_ABILITY_PATCH,  SPECIES_AZURILL },
    { SPECIES_SNORLAX,      ITEM_ABILITY_PATCH, SPECIES_MUNCHLAX },
    { SPECIES_CHANSEY,      ITEM_ABILITY_PATCH, SPECIES_HAPPINY },
    { SPECIES_MR_MIME,      ITEM_ABILITY_PATCH,  SPECIES_MIME_JR },
    { SPECIES_CHIMECHO,     ITEM_ABILITY_PATCH, SPECIES_CHINGLING },
    { SPECIES_SUDOWOODO,    ITEM_ABILITY_PATCH, SPECIES_BONSLY },
    { SPECIES_ROSELIA,      ITEM_ABILITY_PATCH, SPECIES_BUDEW },
    { SPECIES_MANTINE,      ITEM_ABILITY_PATCH, SPECIES_MANTYKE },
};
...
static bool8 TryProduceOrHatchEgg(struct DayCare *daycare)
{
    ...
    // Try to hatch Egg
    daycare->stepCounter++;
    if (((P_EGG_CYCLE_LENGTH <= GEN_3 || P_EGG_CYCLE_LENGTH == GEN_7) && daycare->stepCounter >= 8)
     || (P_EGG_CYCLE_LENGTH == GEN_4 && daycare->stepCounter >= 8)
     || ((P_EGG_CYCLE_LENGTH == GEN_5 || P_EGG_CYCLE_LENGTH == GEN_6) && daycare->stepCounter >= 8)
     || (P_EGG_CYCLE_LENGTH >= GEN_8 && daycare->stepCounter >= 8))
    {
        u32 eggCycles;
