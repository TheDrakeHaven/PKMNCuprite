...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("SAMUEL");
...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. LEE's POKéDEX rating!\pPROF. LEE: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. LEE is in trouble!\nRelease a POKéMON and rescue him!");
