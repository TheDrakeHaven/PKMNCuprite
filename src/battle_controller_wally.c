...
static void WallyHandleDrawTrainerPic(u32 battler)
{
    BtlController_HandleDrawTrainerPic(battler, TRAINER_BACK_PIC_BRENDAN, FALSE,
                                       80, 80 + 4 * (8 - gTrainerBacksprites[TRAINER_BACK_PIC_BRENDAN].coordinates.size),
                                       30);
}

static void WallyHandleTrainerSlide(u32 battler)
{
    BtlController_HandleTrainerSlide(battler, TRAINER_BACK_PIC_BRENDAN);
}
...
static void WallyHandleIntroTrainerBallThrow(u32 battler)
{
    const u32 *trainerPal = gTrainerBacksprites[TRAINER_BACK_PIC_BRENDAN].palette.data;
