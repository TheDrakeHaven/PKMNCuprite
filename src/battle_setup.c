...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SAM] = REMATCH(TRAINER_SAM_1, TRAINER_SAM_2, TRAINER_SAM_3, TRAINER_SAM_4, TRAINER_SAM_5, MAUVILLE_CITY),
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_MATT, TRAINER_MATT, TRAINER_MATT, TRAINER_MATT, TRAINER_MATT, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_OZ, TRAINER_OZ, TRAINER_OZ, TRAINER_OZ, TRAINER_OZ, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_DIEGO, TRAINER_DIEGO, TRAINER_DIEGO, TRAINER_DIEGO, TRAINER_DIEGO, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_FATTY, TRAINER_FATTY, TRAINER_FATTY, TRAINER_FATTY, TRAINER_FATTY, EVER_GRANDE_CITY),
};
...
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_FOONGUS, 5);
    LockPlayerFieldControls();
