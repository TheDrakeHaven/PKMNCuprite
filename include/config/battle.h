...
#define B_FRIENDSHIP_BOOST          GEN_3      // In LGPE only, all stats except HP are boosted up to 10% based on Friendship. Unlike B_BADGE_BOOST, these boosts are accounted when calculating base stats.
...
#define B_FLAG_NO_BAG_USE           FLAG_UNUSED_0x265  // If this flag is set, the ability to use the bag in battle is disabled.
...
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_UNUSED_0x020 // If this flag is set, the player's mons will be controlled by the ai next battles.
